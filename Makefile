...
PROJECT_INC_PATH  = -I./ -I./antble
PROJECT_SRC_PATH  = ./ ./antble
PROJECT_LIB_PATHS = -L.
...
######################################################################################
CFLAGS = -std=gnu99 -c $(CORTEX_MO_CC_FLAGS) $(PROJECT_INC_PATH) -fno-common -fmessage-length=0 -Wall -fno-exceptions -ffunction-sections -fdata-sections
